...
<div class="row p-3">
    ...
    <div class="col-md-12" id="importFrm" style="display: none;">
        <form class="row g-3" action="importData_tft.php" method="post" enctype="multipart/form-data">
            <div class="col-auto">
    ...
    <table class="table table-striped table-bordered">
        ...
        <?php 
        // Get member rows 
        $result = $db->query("SELECT * FROM tft_main"); 
        ...
        ?>
            <tr>
                ...
                <td><?php echo $row['TF_Pin']; ?></td>
                <td><?php echo $row['Reference']; ?></td>
                <td><?php echo $row['DateInvoice']; ?></td>
