...
<div class="row p-3">
    ...
    <div class="col-md-12" id="importFrm" style="display: none;">
        <form class="row g-3" action="importData_ic.php" method="post" enctype="multipart/form-data">
            <div class="col-auto">
    ...
    <table class="table table-striped table-bordered">
        ...
        <?php 
        // Get member rows 
        $result = $db->query("SELECT * FROM  ic_main"); 
        ...
        ?>
            <tr>
                ...
                <td><?php echo $row['ICTC_Number']; ?></td>
                <td><?php echo $row['Remitter_Name']; ?></td>
                <td><?php echo $row['Remitter_Address']; ?></td>
                <td><?php echo $row['Originating_Country']; ?></td>
